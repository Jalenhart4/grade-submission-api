...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http        
            ...
            .csrf().disable()
            .authorizeRequests()  
            .antMatchers("/h2/**", "/swagger-ui/**", "/v3/api-docs/**", "/webjars/swagger-ui/**", "/authenticate").permitAll() // New Line: allows us to access the h2 console, and permit swagger UI without the need to authenticate. ' ** '  instead of ' * ' because multiple path levels will follow.
